...
if(message.content.toLowerCase() === `${prefix}help`){
    ...
    .addField(` ** ❯ LINKS [2]**`,`   [Invite Me](https://discord.com/oauth2/authorize?client_id=830706586128482305&scope=bot&permissions=8589934591&response_type=code&redirect_uri=https%3A%2F%2Fdiscord.gg%2FxZWEkk86uQ)`+` - `+`[Support Server](https://discord.gg/gvVeEEQj7c)`)
    .setFooter("© 𝐌𝐇")
    .setTimestamp()
